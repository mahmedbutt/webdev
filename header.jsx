...
import ProjectsDisplay from "./Projects1.jsx";
import SignIn from "./pages/Signin";
import FilterTester from "./filter";
import {
...
class HeadCoursera extends Component {
  constructor(props) {
    super(props);
    this.state = { search: "web programming" };
  }
  render() {
    const options = [
      "Coursera for Buisness",
      "Coursera for Teams",
      "Coursera for Campus",
      "Coursera for Government",
    ];

    const defaultoptions = "For Enterprise";

    const style2 = {
      display: "flex",
      flexDirection: "row",
      borderBottom: "0.8px solid rgb(209, 206, 206)",
    };
    const style3 = {
      width: "max-content",
      display: "flex",
      ...
      <Router>
        <div style={style2}>
          <div style={style3}>
            ...
            <button class="div_header" style={{ display: "inline" }}>
              Explore
            </button>
            ...
            />
            <button type="submit" style={style5}>
              <BiSearchAlt2 />
            </button>
          </div>

          <div style={style6}>
            <div class="stillheader" style={{}}>
              <Dropdown
                options={options}
            ...
            <div class="stillheader" style={{ marginLeft: "40px" }}>
              For Students
            </div>
